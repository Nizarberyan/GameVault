        ...
        <div class='flex flex-wrap items-center justify-between gap-4 w-full'>
            ...
            <a href="javascript:void(0)"
                class="hidden max-sm:block"><img
                    src="./../media/min_logo.svg" alt="logo" class='w-10 h-fit' />
            </a>
            ...
            <div id="collapseMenu"
                ...
                <ul
                    ...
                    <li class='mb-6 hidden max-lg:block'>
                        <a href="javascript:void(0)"><img src="./../media/min_logo.svg" alt="logo" class='w-20 h-fit' />
                        </a>
                    </li>
                    <li class='max-lg:border-b max-lg:py-3 px-3'>
                        <a href='#'
                            class='hover:text-[#007bff] text-[#007bff] block font-semibold text-[15px]'>Your Profile</a>
                    </li>
                    <li class='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
                            class='hover:text-[#007bff] text-[#333] block font-semibold text-[15px]'>Home Page</a>
                    </li>
                    <li class='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
                            class='hover:text-[#007bff] text-[#333] block font-semibold text-[15px]'>Library</a>
                    </li>
                    <li class='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
                            class='hover:text-[#007bff] text-[#333] block font-semibold text-[15px]'>Forums</a>
                    </li>
                </ul>
            </div>
            ...
            <div class='flex items-center ml-auto space-x-6'>
                <button
                    class='px-4 py-2 text-sm rounded-sm font-bold text-white border-2 border-[#007bff] bg-[#007bff] transition-all ease-in-out duration-300 hover:bg-transparent hover:text-[#007bff]'>Log Out</button>
