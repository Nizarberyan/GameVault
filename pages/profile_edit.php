            ...
            <form action="./../controllers/userController.php?action=accModify" method="POST" enctype="multipart/form-data">
                <div class="flex justify-center mb-6">
                    <label for="profile_image" class="cursor-pointer">
                        <img src="<?= $profile_img; ?>" alt="Profile Picture" id="profileImage" class="w-32 h-32 rounded-full border-4 border-indigo-500 mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="full_name" name="full_name" value="<?= $full_name; ?>" required class="mt-1 p-3 block w-full border-2 border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500">
                </div>

                <div class="mb-4">
                    <label for="email" class="block text-sm font-medium text-gray-700">Email</label>
                    <input type="email" id="email" name="email" value="<?= $email; ?>" required class="mt-1 p-3 block w-full border-2 border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500">
                </div>
